			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"pospos-display": {
								"semanticObject": "pospos",
								"action": "display",
								"description": "Application to capture the sales.",
								"title": "Point of Sales",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pos.pos",
									"url": sap.ui.require.toUrl("pos/pos")
								}
							}
						}
					}
